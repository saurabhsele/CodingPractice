 ...
 */
package StringPractice;// Java program to implement the above approach

class OneSubstringIsSubstringOfOthers {

// Function to check if a String can be  divided into two subStrings such that one subString is subString of the other
